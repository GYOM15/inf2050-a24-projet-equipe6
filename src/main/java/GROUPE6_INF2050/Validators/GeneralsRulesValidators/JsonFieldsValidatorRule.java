...
public class JsonFieldsValidatorRule implements ValidationRule {
    ...
    /**
     * Validates all required fields in the JSON object and logs specific error messages.     *     * @param jsonObject   The JSON object to validate.     * @param errorHandler The error handler to log validation errors.     * @param errorMessage The error message accumulator for detailed validation results.     * @return true if all fields are valid; false otherwise.
     */
